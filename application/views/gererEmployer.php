...
<body>
        ...
        <a class="dropdown-item" href="<?php echo base_url('index.php/controlle/Logout')?>">Deconnexion</a>
            ...
            <div class="card-header">
                    <div class="row g-0 text-center">
                     <div class="col-sm-6 col-md-8 "><h3><i class="fs-4 fa fa-user"></i>Employées Enregistrer</h3></div>
                    <div class="col-6 col-md-4">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#EmployeModal"><i class="fs-5 fa fa-add"></i>Ajouter</button>
                        </div>
                    </div>
                    </div>
                </div>
  ...
  <tbody><?php foreach ($modGr as $compte) { ?>
    ...
    <tr>
        ...
        <td>
            <a type="button" class="btn btn-outline-danger" href="<?php echo site_url('controlle/supprimerEmp/'.$compte->Id_compte) ?>">
                Supprimer
            </a>
        </td>
    </tr>
