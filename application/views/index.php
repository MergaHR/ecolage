...
<body>
			...
			<div class="bg-dark col-auto col-md-4 col-lg-3 min-vh-100 " >
				<div class="gb-dark p-2">
                    ...
                    <?php if ($this->session->userdata('type_compte') == 1 or $this->session->userdata('type_compte') == 2){ ?>
						...
						<li class="nav-item py-2 py-sm-0"><?php if ($this->session->userdata('type_compte') == 1 or $this->session->userdata('type_compte') == 2){ ?>
    ...
    <div class="row g-1 text-center">
        ...
        <div class="col-sm-6 col-md-8">
                ...
                <div class="row row-cols-md-5 card-group">
                    ...
                    if (isset($mod) && (is_array($mod) || is_object($mod))) {
                        ...
                        foreach ($mentionCount as $mention => $count) {
                            ...
                            echo "<div class='card border-primary mb-3 $class' style='max-width: 14rem;'>";
                            ...
                            } elseif ($mention == 'Gestion et Management') {
                            ...
                            echo "<p class='ms d-inline'>$mention</p>";
                            echo '</div>';
                            echo '<div class="card-body">';
                            echo "<h3 class='card-title'>$count</h3>";  // Le nombre est maintenant à l'intérieur de la classe "card-title"
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
            ...
            <div class="card-footer"><center>Institut de Formation Technique </center></div>
        </div>
