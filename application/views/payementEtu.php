...
<body>
        ...
        <a class="dropdown-item" href="<?php echo base_url('index.php/controlle/Logout')?>">Deconnexion</a>
            ...
            <div class="card-header">
                    <div class="row g-0 text-center">
                     ...
                     <center> <div class="col-sm-6 col-md-8 "><h4>Listes des paiements effectué par l'Etudiant<i class="bi bi-check2-all"></i></h4></center>
                    </div>
                </div>
                <div class="card-body">
  ...
  <tbody>
  <?php if(isset($modpayetu) && (is_array($modpayetu) || is_object($modpayetu))): ?>
   
  <tbody><?php foreach($modpayetu as $payementetu): ?>
    <tr>
      <th><?php echo $payementetu->Numero_Matricule; ?></th>
      <td><?php echo $payementetu->DatePayement; ?></td>
      <td><?php echo $payementetu->Modepayer; ?></td>
      <td><?php echo $payementetu->Motif; ?></td>
      <td><?php echo $payementetu->Montant; ?></td>
      <td>
    <img src="<?php echo urlencode($payementetu->Preuve); ?>">
</td>
      ...
      <td>
		 	...
		 	href="<?php echo site_url('controlle/validerPay/'.$payementetu->N)?>"> 
		 	<i class="fa-regular fa-eye"></i> Consulter
		</a>
	  </td>
    <?php } ?>
    </tr>
