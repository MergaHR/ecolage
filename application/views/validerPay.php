...
<body>
    ...
    <?php if ($payementetu): ?>
        ...
        <form method="POST" action="<?php echo site_url('controlle/valPayer/'.$payementetu->N)?>">
    <div class="container">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3>Consulter une paiement <i class="fs-6 fa-regular fa-eye"></i></h3>
            </div>
            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" placeholder="Matricule" aria-label="Matricule" name="Matricule" value="<?php echo $payementetu->Numero_Matricule; ?>" readonly required="">
                    </div>
                    <div class="col">
                        <label for="formGroupExampleInput" class="form-label">Date de paiement</label>
                        <input type="date" class="form-control" name="DatePayer" value="<?php echo $payementetu->DatePayement;?>" readonly required="">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" placeholder="ModePayer" aria-label="ModePayer" name="ModePayer" value="<?php echo $payementetu->Modepayer;?>" readonly required="">
                    </div>
                    <div class="col">
                        <label for="formGroupExampleInput" class="form-label">Motif</label>
                        <input type="text" class="form-control" placeholder="Motif" aria-label="Motif" name="Motif" value="<?php echo $payementetu->Motif;?>" readonly required="">
                    </div>
                    <div class="col">
                        <label for="formGroupExampleInput" class="form-label">Montant</label>
                        <input type="text" class="form-control" placeholder="Montant" aria-label="Montant" name="Montant" value="<?php echo $payementetu->Montant;?>" readonly required="">
                    </div>
            ...
            <div class="card-footer">
               ...
               <button type="submit" class="btn btn-success"  ><i class="bi bi-check2-all"></i>Valider</button>
