            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="card-title mx-3 font-family-roboto text-center">Se Connecter</h4>
                    ...
                    <div class="card-body">
                        <form id="loginForm" method="POST" action="<?php echo site_url('controlle/authentification')?>">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" name="Email_Administration" class="form-control" id="email" required minlength="6">
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Mot de passe</label>
                                <input type="password" name="Mot_de_passe" class="form-control" id="password" required minlength="3">
                            </div>
                            <button id="submitButton" class="btn btn-primary w-100" type="submit">
                                <span class="spinner-border spinner-border-sm visually-hidden" role="status" aria-hidden="true"></span>
                                Se connecter
                            </button>
                            <center> <!-- Ajouter le lien vers la page d'inscription -->
                        <a href="<?php echo base_url('index.php/controlle/inscrire'); ?>" class="btn btn-link">S'inscrire</a>
                    </center>
                        </form>
                    </div>
                </div>
